...
export default function PurchaseDetailsPage(/*{  }: PurchaseDetailsPageType*/) {
  return (
    <>
      <MainContainer>
        ...
        <div className={`mt-11`}>
          ...
          text-5xl w-fit mb-8 leading-tight`}>Account Activities</h1>
            ...
            border  border-red-500 rounded-full px-4 py-2 text-[15.5px] w-fit mb-5`}
                    href={`/account-settings?page=account-settings`}>
            ...
            <div className={`mb-8`}>
              <ViapropertyHeading customClasses={`mb-8`} label={`Purchase Details`} headingSize={`md`} />
              <Paragraph text={(
                <>
            ...
            <Actions chatHref={`/account-settings/chats/1`} type={`forCustomer`} />
