...
export default function LabelAndSelect({ options, disabled = false, required = true, label }: LabelAndSelectType) {
  return (
    <div className={`flex flex-col gap-3 max-w-96 relative`}>
      ...
      <select required={required} name="propertyFor" id="propertyFor" className={`bg-zinc-50 px-4 py-5 pr-10 flex rounded-2xl
