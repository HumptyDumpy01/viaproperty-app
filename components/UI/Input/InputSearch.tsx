  ...
  return (
    <>
      <div className={`relative`}>
        <input type="search" className={`w-[360px] border-2 border-r-zinc-100 py-5
        ...
        <button type={`button`} className={`bg-red-500 h-16 w-16 rounded-xl flex items-center justify-center
            absolute top-[1px] -right-6 transition-all duration-200 hover:bg-red-600 active:bg-red-400`}>
